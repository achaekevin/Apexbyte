          ...
          >
            ...
            <div className="bg-emerald-600 px-4 py-3 text-white flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h4 className="font-bold text-sm leading-tight">Apexbyte Tech Desk</h4>
            ...
            {/* Body */}
            <div className="p-4 space-y-3 bg-gray-50 dark:bg-gray-900/60 text-xs">
              <div className="bg-white dark:bg-gray-800 p-3 rounded-xl shadow-sm border border-gray-150 dark:border-gray-700 leading-relaxed">
              ...
              <div className="space-y-1.5 text-[11px] text-gray-500 dark:text-gray-400">
                <div className="flex items-center gap-2">
                  <FiMapPin className="text-emerald-600 dark:text-emerald-400 shrink-0" />
                  <span>Mocha Place, 2nd Floor, Hospital Rd, Kisii CBD</span>
                </div>
                <div className="flex items-center gap-2">
                  <FiClock className="text-emerald-600 dark:text-emerald-400 shrink-0" />
              ...
              <a
                ...
                className="w-full mt-2 inline-flex items-center justify-center gap-2 py-2.5 px-4 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-xl shadow-md transition-all duration-200 hover:shadow-lg text-xs"
              >
                <FaWhatsapp size={16} />
