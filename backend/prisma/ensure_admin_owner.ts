...
async function main() {
  ...
  const ownerEmail = 'achaekevin@gmail.com';
  ...
  if (existingOwner) {
    ...
    console.log(`✅ Created owner account ${ownerEmail} with SUPER_ADMIN role! Password: Admin@12345`);
  }

  // 2. Default admin account: admin@laptopstore.com
  const defaultAdmin = 'admin@laptopstore.com';
  ...
  if (existingAdmin) {
    ...
    console.log(`✅ Created ${defaultAdmin} with SUPER_ADMIN role! Password: Admin@12345`);
  }
}
